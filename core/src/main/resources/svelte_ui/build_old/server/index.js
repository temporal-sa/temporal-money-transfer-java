import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component, n as noop, a as safe_not_equal } from './chunks/index2-ffc829c8.js';
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<style>\n	.progress-bar {\n	  background: lightgray;\n	  width: 100%;\n	  height: 30px;\n	  overflow: hidden;\n	}\n	.progress {\n	  background: linear-gradient(-45deg, #dfe0e1, #dcddde 25%, #b7b3b9 25%, #c1bfc2 50%, #b7b8b9 50%, #797b7c 75%, #5f5e60 75%, #5e5d5e);\n	  background-size: 200% 200%;\n	  animation: progress-bar-stripes 3s linear infinite;\n	  height: 100%;\n	  transition: width 0.1s;\n	}\n	@keyframes progress-bar-stripes {\n	  0% { background-position: 0 -1rem; }\n	  100% { background-position: 0 0; }\n	}\n  </style>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1">\n		' + head + '\n	\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n",
